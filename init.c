...
/*Correlation comment - Do not change!  Original value='DMDPiNJHkDcJW29r0627GIpiNvka6f90iYZ6lcbOoud_aiTQlcrpAQOiDxLHhA0Qb3xBg8TKlvsFi0IMqolY5kPNLuqjHGt2MOf1JBnK-sFbFk1JWAhFDbE23AgisF13Pw1p8O-X8FY-x4EJr7rn4bCik4yfqxsexc28dHlrl61xmPgk0' Name ='d' Type ='ResponseBased'*/
	...
	web_reg_find("Text=Dashboard", LAST);
/*Correlation comment - Do not change!  Original value='570f752b-8ab3-43cb-9159-0950fdbaf409' Name ='CorrelationParameter' Type ='ResponseBased'*/
	web_reg_save_param_regexp(
		"ParamName=CorrelationParameter",
		"RegExp=121fae78165ba3d4%3aen-US%3a(.*?)%3ab2586c6e",
		SEARCH_FILTERS,
		"Scope=Body",
		"IgnoreRedirections=No",
		"RequestUrl=*/Recruiter.aspx*",
...
/*Correlation comment - Do not change!  Original value=';Telerik.Web.UI, Version=2013.1.220.40, Culture=neutral, PublicKeyToken=121fae78165ba3d4:en-US:d8ebf3de-0179-4fa4-89e6-a030e0cf94a1:53e1db5a:d126a8ef:' Name ='CorrelationParameter_1' Type ='ResponseBased'*/
	web_reg_save_param_regexp(
		"ParamName=CorrelationParameter_1",
		"RegExp==\\ '(.*?)f75bf8aa:35583c8c",
		SEARCH_FILTERS,
		"Scope=Body",
		"IgnoreRedirections=No",
		"RequestUrl=*/Recruiter.aspx*",
...
/*Correlation comment - Do not change!  Original value='.Web.UI.Skins, Version=2013.1.220.40, Culture=neutral, PublicKeyToken=121fae78165ba3d4:en-US:570f752b-8ab3-43cb-9159-0950fdbaf409:' Name ='CorrelationParameter_2' Type ='ResponseBased'*/
	web_reg_save_param_regexp(
		"ParamName=CorrelationParameter_2",
		"RegExp=Telerik(.*?)b2586c6e",
		"Ordinal=2",
		SEARCH_FILTERS,
		"Scope=Body",
		"IgnoreRedirections=No",
